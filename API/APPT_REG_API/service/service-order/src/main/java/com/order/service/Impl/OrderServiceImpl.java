...
import com.user.client.PatientFeignClient;
...
public class OrderServiceImpl extends ServiceImpl<OrderInfoDao, OrderInfo> implements OrderService {
    ...
    public Long saveOrder(String scheduleId, Long patientId) {
        ...
        if(new DateTime(scheduleOrderVo.getStartTime()).isAfterNow()
            ...
            throw new RRException(ResultCodeEnum.TIME_NO);
        }
        // 获取签名信息
        ...
        if(scheduleOrderVo.getAvailableNumber() <= 0) {
            throw new RRException(ResultCodeEnum.NUMBER_NO);
        }
        ...
        if(result.getInteger("code") == 200) {
            ...
            throw new RRException(result.getString("message"), ResultCodeEnum.FAIL.getCode());
        }
    ...
    public Boolean cancelOrder(Long orderId) {
        ...
        if(quitTime.isBeforeNow()) {
            throw new RRException(ResultCodeEnum.CANCEL_ORDER_NO);
        }
        ...
        if(result.getInteger("code") != 200) {
            ...
            if(orderInfo.getOrderStatus().intValue() == OrderStatusEnum.PAID.getStatus().intValue()) {
                ...
                if(!isRefund) {
                    throw new RRException(ResultCodeEnum.CANCEL_ORDER_FAIL);
                }
            }
            //更改订单状态
